import { Stack, Typography, Grid, styled as muiStyled } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      <Stack width={'100%'} justifyContent={'center'} alignItems={'center'}>
        ...
        <Grid item xs={12} md={6} xl={3}  justifyContent={'center'} alignItems={'center'} sx={{ color: 'white' }}>
          <a href="https://github.com/alexandsten" target="_blank" style={{ color: 'white' }}>
        ...
        <Grid item xs={12} md={6} xl={3} sx={{ color: 'white' }}>
          <Stack flexDirection={'row'} gap={2}>
        ...
        <Grid item xs={12} md={6} xl={3} sx={{ color: 'white' }}>
          <a href="https://linkedin.com/in/alex-andstén-47937116b" target="_blank" style={{ color: 'white' }}>
            <Stack flexDirection={'row'} gap={2}>
        ...
        <Grid item xs={12} md={6} xl={3} sx={{ color: 'white' }}>
          <a href="mailto:alex.andsten@hotmail.com" style={{ color: 'white' }}>
            <Stack flexDirection={'row'} gap={2} >
